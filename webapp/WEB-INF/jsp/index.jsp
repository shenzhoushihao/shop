...
<aos:body>
	...
	<div id="div_south_el" class="x-hidden">
		<div class="south_el_left main_text">
			<i class="fa fa-pagelines"></i> ${welcome_msg}, ${user_name}. 所属学院:${org_name}.
		</div>
...
<aos:onready ux="iframe">
	...
	<aos:window id="w_myinfo" title="我的个人设置" iconVec="fa-github-square" iconVecSize="15" resizable="false"
		...
		<aos:formpanel id="f_myinfo" width="650" msgTarget="under" labelWidth="65">
			<aos:fieldset title="基础信息" labelWidth="75" columnWidth="1">
			    <aos:combobox id="college_id" name="college_id" fieldLabel="所属学院" allowBlank="false"  editable="false" columnWidth="0.5" url="baseDataHttpService.getColleges" />
				...
				<aos:textfield name="telephone" fieldLabel="联系电话" maxLength="50" columnWidth="0.5" />
			</aos:fieldset>
		</aos:formpanel>
